...
#DEFAULT_CKPT_PATH = "/data/huggingface_models/Qwen2.5-14B-Instruct"
# DEFAULT_CKPT_PATH = "/data/huggingface_models/appsec_bot-v1" #使用微调”自我认知“后的大模型
DEFAULT_CKPT_PATH = "/data/huggingface_models/appsec_bot-v4"

# DEFAULT_CKPT_PATH = "/data/huggingface_models/safe_v1"

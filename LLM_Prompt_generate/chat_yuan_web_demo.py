...
tokenizer = T5Tokenizer.from_pretrained("/data/huggingface_models/ChatYuan-large-v1")
model = T5ForConditionalGeneration.from_pretrained("/data/huggingface_models/ChatYuan-large-v1")
...
gui.launch(server_name='0.0.0.0', server_port=8083)

...
# 定义路径
input_path = "/root/data/wjy/vip_vul_pro/RAG_VIP_VULN/llm/output_qwen72B_cpe_new_prompt_chi"
result_file = "/root/data/wjy/vip_vul_pro/RAG_VIP_VULN/gradio_show/result_72.txt"

# 定义提取 CPE 内容的正则表达式
cpe_pattern = r'{"cpe": \[.*?\]}'  # 匹配 JSON 格式的 CPE 数据
...
with gr.Blocks() as demo:
    with gr.Row():
        gr.Markdown("### 前100条数据中CPE数据（大模型提取）")
    with gr.Row():
...
# 启动 Gradio 界面
demo.launch(server_name="10.0.81.173", server_port=58086)
